          ...
          <div class="cz-sidebar border-right" id="help-sidebar">
            <div class="profile-img" align="center">
             ...
             <div align="center">
                        ...
                        <a href="{{ url('/purchases') }}" class="btn btn-danger btn-sm">&lt; {{ __('Back') }}</a>
                ...
                <div class="media align-items-center mb-3"><a href="{{ URL::to('/item') }}/{{ $order_details->item_slug }}"><img class="lazy rounded" width="64" height="64" src="{{ Helper::Image_Path($order_details->item_preview,'no-image.png') }}" alt="Post image"></a>
                  <div class="media-body pl-3">
                    <h6 class="blog-entry-title font-size-sm mb-0"><a href="{{ URL::to('/item') }}/{{ $order_details->item_slug }}">{{ $order_details->item_name }}</a></h6><span class="font-size-ms text-muted">{{ Helper::price_format($allsettings->site_currency_position,$order_details->total_price,"symbol") }}</span>
                  </div>
                </div>
