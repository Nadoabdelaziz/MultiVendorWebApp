                   ...
                   <div class="container">
                            ...
                            <div class="col-lg-3 col-md-3">
                              ...
                              <label for="control_{{ $deposit->dep_id }}">
                                <h2>{{ Helper::price_format($allsettings->site_currency_position,$deposit->deposit_price,"symbol") }}</h2>
                                <p>@if($deposit->deposit_bonus != 0) {{ '+'.$deposit->deposit_bonus }} {{ $allsettings->site_currency }} {{ __('Bonus') }} @else {{ __('No Bonus') }}@endif</p>
                              </label>
                            </div>
                            @php $q++; @endphp
                            @endforeach
