        ...
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-star">
              <li class="breadcrumb-item"><a class="text-nowrap" href="{{ URL::to('/') }}"><i class="dwg-home"></i>{{ __('Start Selling') }}</a></li>
              <li class="breadcrumb-item text-nowrap active" aria-current="page">{{ __('Start Selling') }}</li>
            </ol>
          </nav>
        </div>
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0 text-white">{{ __('Start Selling') }}</h1>
        </div>
      </div>
      </div>
    </section>
            ...
            <section class="white-bg">
               <div class="container">
                 <div class="row features mt-3 pt-5 pb-5 mb-5">
                   ...
                   <a href="{{ url('/register') }}" class="btn btn-primary btn-block"><i class="fa fa-chevron-circle-right"></i> {{ __('Sign Up Now') }}</a>
                   </div>
                  </div>
              </div>
           </section>      
