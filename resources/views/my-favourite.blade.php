            ...
            <div class="pt-2 px-4 pl-lg-0 pr-xl-5">
              ...
              <span class="close-floating" data-toggle="tooltip" title="Remove from Favorites"><i class="dwg-close"></i></span></a>
                <div class="media-body text-center text-sm-left">
                  ...
                  <div class="d-inline-block text-accent">{{ Helper::price_format($allsettings->site_currency_position,$price,"symbol") }}</div><a class="d-inline-block text-accent font-size-ms border-left ml-2 pl-2" href="{{ URL::to('/shop') }}/item-type/{{ $featured->item_type }}">{{ str_replace('-',' ',$featured->item_type) }}</a>
