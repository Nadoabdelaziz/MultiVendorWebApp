            ...
            <div class="pt-2 px-4 pl-lg-0 pr-xl-5">
              <div class="row mx-n2 pt-2">
                ...
                <div class="col-md-3 col-sm-12 px-2 mb-4">
                  <div class="bg-secondary h-100 rounded-lg p-4 text-center">
                    ...
                    <p class="h2 mb-2">{{ Helper::price_format($allsettings->site_currency_position,Auth::user()->referral_count,"symbol") }}</p>
                  </div>
                </div>
                @endif
              </div>
              ...
              @endif
                ...
                <div class="d-block mb-3 mb-sm-0 mr-sm-4 mx-auto">
                  ...
                  <div class="font-size-sm"><strong>{{ __('Price') }}:</strong> {{ Helper::price_format($allsettings->site_currency_position,$item->item_price,"symbol") }}</div>
