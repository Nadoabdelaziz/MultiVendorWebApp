        ...
        <div class="row">
          ...
          <section class="col-lg-8 pt-lg-4 pb-4 mb-3">
            <div class="pt-2 px-4 pl-lg-0 pr-xl-5">
              <h2 class="h4 py-2 text-center text-sm-left">{{ __('Minimum withdrawal amount is') }} <span class="link-color">{{ Helper::price_format($allsettings->site_currency_position,$allsettings->site_minimum_withdrawal,"symbol") }}</span></h2>
                    ...
                    <div class="options">
                                @php $no = 1; @endphp
                                            ...
                                            <div class="custom-radio">
                                                <input type="radio" id="withdrawal-{{ $withdraw->withdrawal_key }}" name="withdrawal" value="{{ $withdraw->withdrawal_key }}" data-bvalidator="required">
                                                <label for="withdrawal-{{ $withdraw->withdrawal_key }}">
                                                    {{ $withdraw->withdrawal_name }}</label>
                                            </div>
                                            @php $no++; @endphp
                                            @endforeach
                                 ...
                                 <div>
                                  <label>
                                        <span class="circle"></span>{{ __('Available balance') }}
                                                    <span class="bold">{{ Helper::price_format($allsettings->site_currency_position,Auth::user()->earnings,"symbol") }} </span>
                                                </label>
                                            </div>
                  ...
                  <tbody>
                    @foreach($itemData['item'] as $withdrawal)
                                        <tr>
                                            ...
                                            <td class="bold">{{ Helper::price_format($allsettings->site_currency_position,$withdrawal->wd_amount,"symbol") }}</td>
