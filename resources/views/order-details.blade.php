            ...
            <div class="pt-2 px-4 pl-lg-0 pr-xl-5">
              ...
              <div class="row mt-3 pt-3 mb-3">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                                ...
                                                <td>{{ Helper::price_format($allsettings->site_currency_position,$order->item_price,"symbol") }}</td>
                                                <td>{{ Helper::price_format($allsettings->site_currency_position,$order->vendor_amount,"symbol") }}</td>
                   ...
                   <div class="pricing_info col pull-right">
                        <p>{{ __('Sub Total') }} : {{ Helper::price_format($allsettings->site_currency_position,$earn,"symbol") }}</p>
                        <p class="bold">{{ __('Total') }} : {{ Helper::price_format($allsettings->site_currency_position,$earn,"symbol") }}</p>
                  </div>
                  </div>
               </div>
          </section>
