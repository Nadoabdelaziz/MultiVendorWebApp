                    ...
                    <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-star">
                                ...
                                <li class="breadcrumb-item text-nowrap active" aria-current="page">{{ __('Register') }}
                                </li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="card border-0 box-shadow">
                        <div class="card-body">
                            ...
                            <p class="font-size-sm text-muted mb-4">
                                {{ __('Please fill the following fields with appropriate information to register a new Marketplace account.') }}
                            </p>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="account-fn">{{ __('Your Name') }} <span
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="account-ln">{{ __('Username') }} <span
                                                    class="required">*</span></label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="account-email">{{ __('E-Mail Address') }} <span
                                                    class="required">*</span></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="password-toggle">
                                                <input id="password" type="password" class="form-control"
                                                    ...
                                                    data-bvalidator="required,minlen[6]">@error('password')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                                @enderror
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="email_ad">{{ __('User Type') }} <span
                                                    class="required">*</span></label>
                                            <select id="user_type" class="form-control" name="user_type"
                                                data-bvalidator="required">
                                                <option value=""></option>
                                                <option value="{{ $encrypter->encrypt('customer') }}">
                                                    {{ __('Customer') }}</option>
                                                <option value="{{ $encrypter->encrypt('vendor') }}">{{ __('Vendor') }}
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div
                                            ...
                                            <label>{{ __('Captcha') }} <span class="required">*</span></label>
                                            {!! app('captcha')->display() !!}
                                            @if ($errors->has('g-recaptcha-response'))
                                            <span class="help-block">
                                                <strong
                                                    class="red">{{ $errors->first('g-recaptcha-response') }}</strong>
                                            </span>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex flex-wrap justify-content-between align-items-center">
                                            <div class="custom-checkbox d-block">
                                                <a href="{{ URL::to('/login') }}"
                                                    class="nav-link-inline font-size-sm">{{ __('Already have an account?') }}
                                                    {{ __('Login') }}</a>
                                            </div>
