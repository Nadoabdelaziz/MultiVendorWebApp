          ...
          <aside class="col-lg-4">
            ...
            <div class="cz-sidebar-static h-100 ml-auto border-left">
              ...
              <div class="accordion" id="licenses">
                <div class="card border-top-0 border-left-0 border-right-0">
                  <div class="card-header d-flex justify-content-between align-items-center py-3 border-0">
                    ...
                    <h5 class="mb-0 text-accent font-weight-normal" id="regular_price">{{ Helper::price_format($allsettings->site_currency_position,$item_price,"symbol") }}</h5>
                  </div>
                ...
                <div class="card border-bottom-0 border-left-0 border-right-0">
                  <div class="card-header d-flex justify-content-between align-items-center py-3 border-0">
                    ...
                    <h5 class="mb-0 text-accent font-weight-normal" id="extend_price">{{ Helper::price_format($allsettings->site_currency_position,$extend_item_price,"symbol") }}</h5>
                  </div>
              ...
              <ul class="list-unstyled font-size-sm">
                ...
                <li class="d-flex justify-content-between mb-3 pb-3 border-bottom"><span class="text-dark font-weight-medium">{{ __('Item Type') }}</span><span class="text-muted">{{ str_replace('-',' ',$item['item']->item_type) }}</span></li>
          ...
          <div class="card product-card-alt">
            ...
            <div class="card-body">
              ...
              <div class="d-flex flex-wrap justify-content-between align-items-center">
                ...
                <div>@if($featured->item_flash == 1)<del class="price-old">{{ Helper::price_format($allsettings->site_currency_position,$featured->regular_price,"symbol") }}</del>@endif <span class="bg-faded-accent text-accent rounded-sm py-1 px-2">{{ Helper::price_format($allsettings->site_currency_position,$price,"symbol") }}</span></div>
              </div>
            </div>
          </div>
        </div>
...
$("#qty").change(function(){ 
   ...
   if(types == "left")
   {
   $("#regular_price").html("{{ $allsettings->site_currency_symbol }}"+first_price);
   $("#extend_price").html("{{ $allsettings->site_currency_symbol }}"+second_price); 
   }
   else
   {
   $("#regular_price").html(first_price+"{{ $allsettings->site_currency_symbol }}");
   $("#extend_price").html(second_price+"{{ $allsettings->site_currency_symbol }}"); 
   }
});
</script>
@endif
