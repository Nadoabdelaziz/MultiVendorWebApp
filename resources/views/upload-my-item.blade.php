          ...
          <section class="col-lg-8 pt-lg-4 pb-4 mb-3">
            ...
            <div class="row">
             <div class="col-sm-12 mb-1">
              ...
              <div class="col-sm-12 mb-1">
              <div class="alert alert-info alert-with-icon font-size-sm mb-4" role="alert">
                <div class="alert-icon-box"><i class="alert-icon dwg-announcement"></i></div><b>{{ __('Image Upload') }} :</b> jpeg, jpg, png, webp<br/><b>{{ __('File Upload') }} :</b> zip, mp3, mp4<?php /*?>@if(Auth::user()->user_subscr_space_level == 'limited') <br/><b>Available Storage Space : </b> {{ Auth::user()->user_subscr_space }} {{ Auth::user()->user_subscr_space_type }} @endif | <?php */?>
             ...
             <form action="{{ route('upload-item') }}" class="setting_form" id="item_form" method="post" enctype="multipart/form-data">
              ...
              <div class="col-sm-6" id="main_file">
                <div class="form-group">
                  <label for="account-fn">{{ __('Upload Main File') }} <span class="require">*</span> ({{ __('ZIP - All files') }} @if($addition_settings->subscription_mode == 1) @if(Auth::user()->user_subscr_space_level == 'limited')| Max Size : {{ Auth::user()->user_subscr_space }} {{ Auth::user()->user_subscr_space_type }} @endif @endif)</label>
