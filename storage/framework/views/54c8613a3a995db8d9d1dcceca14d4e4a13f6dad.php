...
<footer class="bg-dark pt-5">
      <div class="container pt-2 pb-3">
        <div class="row">
          <div class="col-md-4 text-center text-md-left mb-4">
            ...
            <h6 class="pr-3 mr-3"><span class="text-primary"><?php echo e($total_sale); ?> </span><span class="font-weight-normal text-white"><?php echo e(__('Sales')); ?></span></h6><h6 class="mr-3"><span class="text-primary"><?php echo e($total_files); ?> </span><span class="font-weight-normal text-white"><?php echo e(__('Files')); ?></span></h6> 
    ...
    <?php endif; ?>
    <a class="btn-scroll-top" href="#top" data-scroll><span class="btn-scroll-top-tooltip text-muted font-size-sm mr-2"><?php echo e(__('Top')); ?></span><i class="btn-scroll-top-icon dwg-arrow-up"></i></a><?php /**PATH C:\xampp\htdocs\fickrr2\resources\views/footer.blade.php ENDPATH**/ ?>