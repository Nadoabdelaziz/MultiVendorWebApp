            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><?php echo e(__('Start Selling')); ?></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                        ...
                        <div class="card">
                           ...
                           <div class="col-md-4">
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Box')); ?> 1 <?php echo e(__('Icon')); ?> ( 75 X 75px )</label>
                                                ...
                                                <img class="lazy" width="24" height="24" src="<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($setting['setting']->box1_icon); ?>" />
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Box')); ?> 1 <?php echo e(__('Title')); ?></label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Box')); ?> 1 <?php echo e(__('Content')); ?></label>
                                             ...
                                             <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Box')); ?> 3 <?php echo e(__('Icon')); ?> ( 75 X 75px )</label>
                                                ...
                                                <img class="lazy" width="24" height="24" src="<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($setting['setting']->box3_icon); ?>" />
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Box')); ?> 3 <?php echo e(__('Title')); ?></label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Box')); ?> 3 <?php echo e(__('Content')); ?></label>
                             ...
                             <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                           ...
                                           <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Box')); ?> 2 <?php echo e(__('Icon')); ?> ( 75 X 75px )</label>
                                                ...
                                                <img class="lazy" width="24" height="24" src="<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($setting['setting']->box2_icon); ?>" />
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Box')); ?> 2 <?php echo e(__('Title')); ?></label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Box')); ?> 2 <?php echo e(__('Content')); ?></label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Box')); ?> 4 <?php echo e(__('Icon')); ?> ( 75 X 75px )</label>
                                                ...
                                                <img class="lazy" width="24" height="24" src="<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($setting['setting']->box4_icon); ?>" />
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Box')); ?> 4 <?php echo e(__('Title')); ?></label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Box')); ?> 4 <?php echo e(__('Content')); ?></label>
                             ...
                             <div class="col-md-4">
                                <h4 align="center" class="mt-3 mb-3"> <?php echo e(__('Layout Look')); ?></h4>
                                <img  class="lazy layout-img" width="390" height="518" src="<?php echo e(url('/')); ?>/public/img/layout.jpg"  />
                             </div>
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Three Box Title')); ?></label>
                             ...
                             <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                           ...
                                           <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Box')); ?> 5 <?php echo e(__('Icon')); ?> ( 75 X 75px )</label>
                                                ...
                                                <img class="lazy" width="24" height="24" src="<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($setting['setting']->box5_icon); ?>"  />
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Box')); ?> 5 <?php echo e(__('Title')); ?></label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Box')); ?> 5 <?php echo e(__('Content')); ?></label>
                             ...
                             <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                           ...
                                           <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Box')); ?> 6 <?php echo e(__('Icon')); ?> ( 75 X 75px )</label>
                                                ...
                                                <img class="lazy" width="24" height="24" src="<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($setting['setting']->box6_icon); ?>" />
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Box')); ?> 6 <?php echo e(__('Title')); ?></label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Box')); ?> 6 <?php echo e(__('Content')); ?></label>
                             ...
                             <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                           ...
                                           <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Box')); ?> 7 <?php echo e(__('Icon')); ?> ( 75 X 75px )</label>
                                                ...
                                                <img class="lazy" width="24" height="24" src="<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($setting['setting']->box7_icon); ?>" />
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Box')); ?> 7 <?php echo e(__('Title')); ?></label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Box')); ?> 7 <?php echo e(__('Content')); ?></label>
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Title')); ?> 1</label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Content')); ?> 1</label>
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Title')); ?> 2</label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Content')); ?> 2</label>
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Title')); ?> 3</label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Content')); ?> 3</label>
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Button Title')); ?></label>
...
<?php /**PATH C:\xampp\htdocs\fickrr\resources\views/admin/start-selling.blade.php ENDPATH**/ ?>