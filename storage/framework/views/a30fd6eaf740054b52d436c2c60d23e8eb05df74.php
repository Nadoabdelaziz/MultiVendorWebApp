        ...
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-star">
              ...
              <li class="breadcrumb-item text-nowrap active" aria-current="page"><?php echo e(__('Deposit')); ?></li>
              </li>
             </ol>
          </nav>
        </div>
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0 text-white"><?php echo e(__('Deposit')); ?></h1>
        </div>
      </div>
    </div>
<div class="container mb-5 pb-3">
                   ...
                   <div class="container">
                            ...
                            <div class="col-lg-3 col-md-3">
                              ...
                              <label for="control_<?php echo e($deposit->dep_id); ?>">
                                <h2><?php echo e(Helper::price_format($allsettings->site_currency_position,$deposit->deposit_price,"symbol")); ?></h2>
                                <p><?php if($deposit->deposit_bonus != 0): ?> <?php echo e('+'.$deposit->deposit_bonus); ?> <?php echo e($allsettings->site_currency); ?> <?php echo e(__('Bonus')); ?> <?php else: ?> <?php echo e(__('No Bonus')); ?><?php endif; ?></p>
                              </label>
                            </div>
                            <?php $q++; ?>
                     ...
                     <div class="row">
                         ...
                         <div class="information_module payment_options">
                                <div class="toggle_title">
                                    <h4><?php echo e(__('Select Payment Method')); ?></h4>
                                </div>
    ...
    </div><?php /**PATH C:\xampp\htdocs\fickrr\resources\views/my-deposit.blade.php ENDPATH**/ ?>