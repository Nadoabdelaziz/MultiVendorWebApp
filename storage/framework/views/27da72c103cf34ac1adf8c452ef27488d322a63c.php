                    ...
                    <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-star">
                                ...
                                <li class="breadcrumb-item text-nowrap active" aria-current="page"><?php echo e(__('Register')); ?>
                    ...
                    <div class="card border-0 box-shadow">
                        <div class="card-body">
                            ...
                            <p class="font-size-sm text-muted mb-4">
                                <?php echo e(__('Please fill the following fields with appropriate information to register a new Marketplace account.')); ?>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="account-fn"><?php echo e(__('Your Name')); ?> <span
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="account-ln"><?php echo e(__('Username')); ?> <span
                                                    class="required">*</span></label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="account-email"><?php echo e(__('E-Mail Address')); ?> <span
                                                    class="required">*</span></label>
                                            <input id="email" type="text" class="form-control" name="email"
                                                value="<?php echo e(old('email')); ?>"
                                                placeholder="<?php echo e(__('Enter your email address')); ?>" autocomplete="email"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="password-toggle">
                                                <input id="password" type="password" class="form-control"
                                                    name="password" placeholder="<?php echo e(__('Enter your password')); ?>"
                                                    autocomplete="new-password"
                                                    data-bvalidator="required,minlen[6]"><?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="email_ad"><?php echo e(__('User Type')); ?> <span
                                                    class="required">*</span></label>
                                            <select id="user_type" class="form-control" name="user_type"
                                                data-bvalidator="required">
                                                <option value=""></option>
                                                <option value="<?php echo e($encrypter->encrypt('customer')); ?>">
                                                    <?php echo e(__('Customer')); ?></option>
                                                <option value="<?php echo e($encrypter->encrypt('vendor')); ?>"><?php echo e(__('Vendor')); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="password-toggle">
                                                <input id="password-confirm" type="password" class="form-control"
                                                    ...
                                                    data-bvalidator="equal[password],required,minlen[6]"
                                                    autocomplete="new-password">
                                                <label class="password-toggle-btn">
                                                    <input class="custom-control-input" type="checkbox"><i
                                                        class="dwg-eye password-toggle-indicator"></i><span
                                    ...
                                    <div class="col-sm-12">
                                        <div
                                            ...
                                            <span class="help-block">
                                                <strong
                                                    class="red"><?php echo e($errors->first('g-recaptcha-response')); ?></strong>
                                            </span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                        ...
                                        <div class="d-flex flex-wrap justify-content-between align-items-center">
                                            <div class="custom-checkbox d-block">
                                                <a href="<?php echo e(URL::to('/login')); ?>"
                                                    class="nav-link-inline font-size-sm"><?php echo e(__('Already have an account?')); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\fickrr\resources\views/auth/register.blade.php ENDPATH**/ ?>