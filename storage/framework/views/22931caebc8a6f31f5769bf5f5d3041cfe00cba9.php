        ...
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-star">
              ...
              <li class="breadcrumb-item text-nowrap active" aria-current="page"><?php echo e(__('Favourites')); ?></li>
              </li>
             </ol>
          </nav>
        </div>
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0 text-white"><?php echo e(__('My Favourites')); ?></h1>
        </div>
      </div>
    </div>
<div class="container mb-5 pb-3">
        ...
        <div class="row">
          ...
          <section class="<?php if(Auth::user()->id == 1): ?> col-lg-12 pl-4 <?php else: ?> col-lg-8 <?php endif; ?> pt-lg-4 pb-4 mb-3">
            <div class="pt-2 px-4 pl-lg-0 pr-xl-5">
              <h2 class="h3 pt-2 pb-4 mb-0 text-center text-sm-left border-bottom"><?php echo e(__('My Favourites')); ?><span class="badge badge-secondary font-size-sm text-body align-middle ml-2"><?php echo e(count($fav['item'])); ?></span></h2>
              <!-- Product-->
                <?php $no = 1; ?>
              ...
              <a class="d-block position-relative mb-3 mb-sm-0 mr-sm-4 mx-auto cart-img" href="<?php echo e(url('/favourites')); ?>/<?php echo e(base64_encode($featured->fav_id)); ?>/<?php echo e(base64_encode($featured->item_id)); ?>" onClick="return confirm('<?php echo e(__('Are you sure you want to remove from favourites?')); ?>');">
              ...
              <span class="close-floating" data-toggle="tooltip" title="Remove from Favorites"><i class="dwg-close"></i></span></a>
                <div class="media-body text-center text-sm-left">
                  ...
                  <div class="d-inline-block text-accent"><?php echo e(Helper::price_format($allsettings->site_currency_position,$price,"symbol")); ?></div><a class="d-inline-block text-accent font-size-ms border-left ml-2 pl-2" href="<?php echo e(URL::to('/shop')); ?>/item-type/<?php echo e($featured->item_type); ?>"><?php echo e(str_replace('-',' ',$featured->item_type)); ?></a>
                  <div class="form-inline pt-2">
                    <?php echo e(mb_substr($featured->item_shortdesc,0,60,'utf-8').'...'); ?>

                    <a class="btn btn-primary btn-sm mx-auto mx-sm-0 my-2" href="<?php echo e(URL::to('/item')); ?>/<?php echo e($featured->item_slug); ?>"><i class="dwg-cart mr-1"></i><?php echo e(__('View Product')); ?></a></div>
                </div>
              </div>
              <?php $no++; ?>
    ...
    </div><?php /**PATH C:\xampp\htdocs\fickrr\resources\views/my-favourite.blade.php ENDPATH**/ ?>