...
<div class="container py-5 mt-md-2 mb-2">
      <div class="row">
        <div class="col-lg-12" data-aos="fade-up" data-aos-delay="200" align="center">
          <h4><?php echo e(__('Your subscription has been expired. Please renewal your')); ?> <a href="<?php echo e(URL::to('/subscription')); ?>"><?php echo e(__('Subscription')); ?></a></h4><br/>
         </div>
      </div>
    </div><?php /**PATH C:\xampp\htdocs\fickrr\resources\views/expired.blade.php ENDPATH**/ ?>