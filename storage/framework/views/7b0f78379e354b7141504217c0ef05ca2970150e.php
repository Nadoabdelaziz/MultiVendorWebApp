        ...
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-star">
              ...
              <li class="breadcrumb-item text-nowrap active" aria-current="page"><?php echo e(__('Coupon')); ?></li>
              </li>
             </ol>
          </nav>
        </div>
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0 text-white"><?php echo e(__('Coupon')); ?></h1>
        </div>
      </div>
    </div>
<div class="container mb-5 pb-3">
        ...
        <div class="row">
          ...
          <section class="col-lg-8 pt-lg-4 pb-4 mb-3">
            <div class="pt-2 px-4 pl-lg-0 pr-xl-5">
              <h2 class="h3 pt-2 pb-4 mb-0 text-center text-sm-left border-bottom"><?php echo e(__('Coupon')); ?></h2>
              <!-- Product-->
                <div class="row">
                 <div class="col-lg-12 col-md-12 text-right mb-3 mt-3">
                 <a href="<?php echo e(URL::to('/add-coupon')); ?>" class="btn btn-success btn-sm"><?php echo e(__('Add Coupon')); ?></a>
                 </div>
                 </div>
                 <div class="row">
                    <div class="col-md-12">
                                ...
                                <tbody id="listShow">
                                    ...
                                    <?php $__currentLoopData = $couponData['view']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="prod-item">
                                            ...
                                            <td><?php if($coupon->coupon_status == 1): ?> <span class="badge badge-success"><?php echo e(__('Active')); ?></span> <?php else: ?> <span class="badge badge-danger"><?php echo e(__('InActive')); ?></span> <?php endif; ?></td>
                                            <td>
                                            <a href="<?php echo e(URL::to('/edit-coupon')); ?>/<?php echo e(base64_encode($coupon->coupon_id)); ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i>&nbsp; <?php echo e(__('Edit')); ?></a> 
                                            <?php if($demo_mode == 'on'): ?> 
                                            <a href="demo-mode" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i>&nbsp;<?php echo e(__('Delete')); ?></a>
                                            <?php else: ?> 
                                            <a href="<?php echo e(URL::to('/coupon')); ?>/<?php echo e(base64_encode($coupon->coupon_id)); ?>" class="btn btn-danger btn-sm" onClick="return confirm('<?php echo e(__('Are you sure you want to remove this coupon?')); ?>');"><i class="fa fa-trash"></i>&nbsp;<?php echo e(__('Delete')); ?></a> 
                                             <?php endif; ?>
                                             </td>
                                        </tr>
                                        <?php $no++; ?>
    ...
    </div><?php /**PATH C:\xampp\htdocs\fickrr\resources\views/my-coupon.blade.php ENDPATH**/ ?>