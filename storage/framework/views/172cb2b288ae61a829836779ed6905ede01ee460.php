                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                                ...
                                                <input id="mail_driver" name="mail_driver" type="text" class="form-control noscroll_textarea" value="<?php echo e($setting['setting']->mail_driver); ?>" data-bvalidator="required"> <small><?php echo e(__('example')); ?> : mail or smtp</small></div>
                                    <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Mail Port')); ?> <span class="require">*</span></label>
                                                <input id="mail_port" name="mail_port" type="text" class="form-control noscroll_textarea" value="<?php echo e($setting['setting']->mail_port); ?>" data-bvalidator="required"> <small><?php echo e(__('example')); ?> : 25</small></div><div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Mail Password')); ?></label>
                                                <input id="mail_password" name="mail_password" type="text" class="form-control noscroll_textarea" value="<?php echo e($setting['setting']->mail_password); ?>"> <small><?php echo e(__('example')); ?> : test123</small>
                                                </div>
                                                </div>
                                                </div>
                                          </div>
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                                ...
                                                <input id="mail_host" name="mail_host" type="text" class="form-control noscroll_textarea" value="<?php echo e($setting['setting']->mail_host); ?>" data-bvalidator="required"> <small><?php echo e(__('example')); ?> : mail.mailtrap.io</small></div>
                                   <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Mail Username')); ?> </label>
                                                <input id="mail_username" name="mail_username" type="text" class="form-control noscroll_textarea" value="<?php echo e($setting['setting']->mail_username); ?>"> <small><?php echo e(__('example')); ?> : sample@sample.com</small></div><div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(__('Mail Encryption')); ?> </label>
                                                <input id="mail_encryption" name="mail_encryption" type="text" class="form-control noscroll_textarea" value="<?php echo e($setting['setting']->mail_encryption); ?>"> <small><?php echo e(__('example')); ?> : tls or ssl</small></div>                  
                               </div>
                                </div>
                              </div>
                             </div>
...
</html><?php /**PATH C:\xampp\htdocs\fickrr\resources\views/admin/email-settings.blade.php ENDPATH**/ ?>